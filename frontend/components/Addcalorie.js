    ...
    this.setState(
      ...
      () => {
        this.props.update("updateCalorie", {
          currentCalorie: this.state.currentCalorie
        });
        storeCurrentCalorieOffline = async () => {
          try {
            await AsyncStorage.setItem(
              "SNAPDIET_CURRENTCALORIE",
              this.state.currentCalorie.toString()
            );
          } catch (e) {
            console.log(e);
          }
    ...
    this.setState(
      {
        ...
        chosenCalories: this.state.chosenCalories.concat([
          parseInt(this.state.foodValues[this.state.foodNames.indexOf(item)])
        ]),
  ...
  addQty = item => {
    for (i in this.state.chosenFoods) {
      if (this.state.chosenFoods[i] == item) {
        ...
        let arr = this.state.chosenCalories;
        arr[i] += parseInt(
          this.state.foodValues[this.state.foodNames.indexOf(item)]
        );
        this.setState(
          {
            chosenCalories: arr
      ...
      return (
        <View>
          <View style={styles.foodCard}>
            <Text style={{ color: "rgba(0,0,0,0.87)", fontFamily: "openSans" }}>
              {food}
            </Text>
            {this.state.chosenFoodMultiplier.length - 1 >=
            this.state.chosenFoods.indexOf(food) ? (
              <Text
                style={{
              ...
              >
                (x{this.state.chosenFoodMultiplier[
                  this.state.chosenFoods.indexOf(food)
                ] + 1})
              </Text>
            ) : null}
      ...
      return (
        <View>
          <View style={styles.foodCard2}>
            <Text
              style={{ color: "rgba(0,0,0,0.87)", fontFamily: "openSans-bold" }}
            >
              {calorie}
            </Text>
          </View>
      ...
      return (
        <View>
          ...
          >
            ...
            >
              <View
                style={[styles.buttons, { backgroundColor: "rgb(46,204,113)" }]}
              >
            ...
            >
              <View
                style={[styles.buttons, { backgroundColor: "rgb(52,152,219)" }]}
              >
            ...
            >
              <View
                style={[styles.buttons, { backgroundColor: "rgb(231,76,60)" }]}
              >
        ...
        <View style={styles.container}>
          <Item>
            <Input
              ...
              value={this.state.foodNameEntered}
            />
          </Item>
          <FlatList
            style={styles.list}
              ...
              return (
                <View key={item.index}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      this.choseItem(item.item);
                    }}
                  >
                    <Text style={{ color: "black", fontFamily: "openSans" }}>
                      {item.item}
                    </Text>
                  </TouchableOpacity>
                  <View
